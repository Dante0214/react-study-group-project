...
// netlify/functions/getWebSearch.js
var getWebSearch_exports = {};
__export(getWebSearch_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(getWebSearch_exports);
...
// netlify/utils/client.js
console.log("OpenAI \uD074\uB77C\uC774\uC5B8\uD2B8 \uC0DD\uC131 \uC911...");
console.log("API \uD0A4 \uC124\uC815 \uC5EC\uBD80:", process.env.OPENAI_API_KEY ? "\uC124\uC815\uB428" : "\uC124\uC815\uB418\uC9C0 \uC54A\uC74C");
var client = new openai_default({
...
// netlify/functions/getWebSearch.js
var getWebSearchResponse = async (prompt) => {
  try {
...
var handler = async function(event, context) {
  ...
  try {
    ...
    const response = await getWebSearchResponse(prompt);
...
*/
//# sourceMappingURL=getWebSearch.js.map
